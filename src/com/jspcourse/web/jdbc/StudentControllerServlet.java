package com.jspcourse.web.jdbc;
...
public class StudentControllerServlet extends HttpServlet {
	...
	// in a normal class you would use the constructor but in servlets
	// you need to override the init() method inherited from Servlet parent class
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// read the "command" parameter
			String theCommand = request.getParameter("command");
			// route to the appropriate mehtod
			switch (theCommand) {
			case "ADD":
	...
	private void addStudent(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// SEND AS REDIRECT to avoid multiple-browser reload issue that keeps adding
		// duplicates to list
